...
include_once __DIR__ . '/../../connexion.php';
	class ModeleProfil extends connexion{
		...
		public function recupereInfoUtilisateurCo(){
			$idUser=isset($_GET['idprofil']) ? $_GET['idprofil'] : -1;

			if(self::utilisateurConnecter()){
		...
		public function traduitResultatRequeteCo($result){
		...
		public function nbTrajetsEtNote(){
			$idUser=isset($_GET['idprofil']) ? $_GET['idprofil'] : -1;
