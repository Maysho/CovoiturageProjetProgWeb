  		...
  		?>
	  			...
	  			<div class="col-6 row offset-1 justify-content-between" >
					<div class=" justify-content-between row container">
						<span class="col-12 col-md-6">Départ de <?php echo $donnee['depart'];?></span>
						<span class="col-6 text-right"> à <?php echo $donnee['heureDepart'];?></span>
					</div>
						<div class="align-items-end justify-content-between row container">
						<span class="col-12 col-md-6" style="padding-right: 3px;">Arrivé à <?php echo $donnee['destination'];?></span>
						<span class="col-6 text-right" > à <?php echo $donnee['heureArrivee'];?></span>
						</div>
					</div>
				<div class="col-md-2 row offset-1  justify-content-end ">
					<div class="row justify-content-end col-12">
						<span class="align-top">Places Dispo <?php echo $donnee['placeTotale']; ?></span>
					</div>
